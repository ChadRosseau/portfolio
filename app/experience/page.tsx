							...
							{topRow.map((experience, i) => {
								return (
									<Branch
										...
										top={true}
										i={2 * i + (experiencesList.length % 2 ? 0 : 1)}
										final={
							...
							{bottomRow.map((experience, i) => {
								return (
									<Branch
										...
										key={experience.name + experience.startDate}
										top={false}
										i={2 * i + (experiencesList.length % 2 ? 1 : 0)}
										final={
											experience == experiencesList[experiencesList.length - 1]
										}
										cancelled={animCancelled}
						...
						return (
							...
							>
								<a
									...
									rel={experience.link ? "noreferrer" : undefined}
								>
									...
									<div className="ml-1">
										...
										<div className="mt-3 flex flex-wrap gap-2">
											{experience.skills.map((skillTag: SkillTag, j) => {
												const skill = allSkillList.find(
													(s) => s.icon_url === skillTag,
												);
												...
												return (
													<FlippedImage
														...
														className={clsx(
															...
															j !== experience.skills.length - 1 && "mr-1",
														)}
														startDelay={0}
														cancelled={false}
													/>
