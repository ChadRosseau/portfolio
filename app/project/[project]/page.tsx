                ...
                <div className="flex h-full w-[10%] flex-col items-center justify-between">
                    ...
                    <div
                        className={clsx(
                            ...
                            'relative flex h-[65%] w-2/3 flex-col items-center justify-start overflow-hidden rounded-2xl border border-[#fff] border-opacity-10 bg-dark-200 p-5 transition-all delay-75 duration-300'
                        )}
                    >
