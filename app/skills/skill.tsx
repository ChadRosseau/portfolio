	...
	return (
		...
		>
			<div
				...
				style={{ ["animationDelay" as any]: delay }}
			>
				<div className={styles.skillInner}>
                    ...
                    /> */}
						...
						<div
							className={styles.dot}
							style={{
								backgroundColor: skill.proficiency >= 2 ? "#00ffaa" : "none",
							}}
						></div>
						<div
							className={styles.dot}
							style={{
								backgroundColor: skill.proficiency >= 3 ? "#00ffcc" : "none",
							}}
						></div>
						<div
							className={styles.dot}
							style={{
								backgroundColor: skill.proficiency >= 4 ? "#00ffee" : "none",
							}}
						></div>
					</div>
				</div>
